...
print(name)
```
- Functions take arguments that influence their behavior. If we look at the documentation for ```[print](https://chat.openai.com/c/e9871894-6fe4-4428-9371-fdad8fd823f1)``` you’ll notice we can learn a lot about the arguments that the print function takes.
